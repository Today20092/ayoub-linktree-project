...
The website was built with Astro, Tailwind CSS, shadcn/ui, T3 Chat, Codex CLI, and an AI-assisted development workflow. The [source is public on GitHub](https://github.com/Today20092/yahala-usa-linktree).

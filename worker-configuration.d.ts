/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f514e3ad319d7a3f66ab3d13be9023b5)
// Runtime types generated with workerd@1.20260625.1 2026-06-20 nodejs_compat
interface __BaseEnv_Env {
	GALLERY_PUBLIC: R2Bucket;
	GALLERY_PENDING: R2Bucket;
	GALLERY_DB: D1Database;
	VECTORIZE: VectorizeIndex;
	FACE_SEARCH_RATE_LIMITER: RateLimit;
	GALLERY_PASSWORD_RATE_LIMITER: RateLimit;
	GALLERY_UPLOAD_RATE_LIMITER: RateLimit;
	IMAGES: ImagesBinding;
	GALLERY_ADMIN_EMAIL: "ayoub.abedrabbo@gmail.com";
	GALLERY_ACCESS_TEAM_DOMAIN: "https://ayoub-abedrabbo.cloudflareaccess.com";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GALLERY_ADMIN_EMAIL" | "GALLERY_ACCESS_TEAM_DOMAIN">> {}
}
